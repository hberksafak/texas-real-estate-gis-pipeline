...
| 5 | Texas School District Boundaries | School district context overlay | Use as neutral context only. | Do not use for discriminatory or fair-housing-risk ranking. Keep analysis language neutral and descriptive. |
| 6 | HUD Opportunity Zones | Incentive/context overlay | Use as business and incentive context. | Do not use demographic targeting language. Use the tract overlay only as a policy/incentive geography. |
